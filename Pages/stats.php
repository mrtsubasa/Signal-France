    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="text-center mb-12 fade-in">
            ...
            <p class="text-lg text-neutral-600 max-w-2xl mx-auto">
                Vue d'ensemble des données de la plateforme Signale France
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
            <!-- Total Signalements -->
            <div class="metric-card fade-in" style="--gradient: linear-gradient(90deg, var(--primary-soft), var(--secondary-soft)); animation-delay: 0.1s;">
            ...
            <!-- Ce Mois -->
            <div class="metric-card fade-in" style="--gradient: linear-gradient(90deg, var(--accent-soft), var(--secondary-soft)); animation-delay: 0.2s;">
                <div class="flex items-center justify-between mb-3">
            ...
            <!-- Cette Semaine -->
            <div class="metric-card fade-in" style="--gradient: linear-gradient(90deg, var(--warning-soft), var(--accent-soft)); animation-delay: 0.3s;">
                <div class="flex items-center justify-between mb-3">
            ...
            <!-- Aujourd'hui -->
            <div class="metric-card fade-in" style="--gradient: linear-gradient(90deg, var(--danger-soft), var(--warning-soft)); animation-delay: 0.4s;">
                <div class="flex items-center justify-between mb-3">
            ...
            <!-- Utilisateurs Actifs -->
            <div class="metric-card fade-in" style="--gradient: linear-gradient(90deg, var(--secondary-soft), var(--primary-soft)); animation-delay: 0.5s;">
                <div class="flex items-center justify-between mb-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div class="stats-card p-6 fade-in" style="animation-delay: 0.6s;">
                <h3 class="section-title">
                    <i class="fas fa-tasks" style="background: linear-gradient(135deg, var(--primary-soft), var(--secondary-soft)); color: white;"></i>
                ...
                <div class="space-y-3">
                    ...
                    <div class="list-item">
                        ...
                        <span class="badge" style="background-color: rgba(79, 70, 229, 0.1); color: var(--primary-soft);">
            ...
            <div class="stats-card p-6 fade-in" style="animation-delay: 0.7s;">
                <h3 class="section-title">
                    <i class="fas fa-exclamation-circle" style="background: linear-gradient(135deg, var(--warning-soft), var(--danger-soft)); color: white;"></i>
                    Types d'Incidents
                </h3>
                <div class="space-y-3">
                    ...
                    <div class="list-item">
                        <div class="flex items-center">
                            ...
                            <span class="text-neutral-700 font-medium"><?= htmlspecialchars($type['type_incident']) ?></span>
                        </div>
                        <span class="badge" style="background-color: rgba(245, 158, 11, 0.1); color: var(--warning-soft);">
            ...
            <div class="stats-card p-6 fade-in" style="animation-delay: 0.8s;">
                <h3 class="section-title">
                    <i class="fas fa-flag" style="background: linear-gradient(135deg, var(--danger-soft), var(--warning-soft)); color: white;"></i>
                    Niveaux de Priorité
                </h3>
                <div class="space-y-3">
                    ...
                    <div class="list-item">
                        <div class="flex items-center">
                            ...
                            <span class="text-neutral-700 font-medium"><?= htmlspecialchars($priorite['priorite']) ?></span>
                        </div>
                        <span class="badge" style="background-color: rgba(239, 68, 68, 0.1); color: var(--danger-soft);">
            ...
            <div class="stats-card p-6 fade-in" style="animation-delay: 0.9s;">
                <h3 class="section-title">
                    <i class="fas fa-map-marker-alt" style="background: linear-gradient(135deg, var(--accent-soft), var(--secondary-soft)); color: white;"></i>
                ...
                <div class="space-y-3">
                    ...
                    <div class="list-item">
                        <div class="flex items-center">
                            ...
                            <span class="text-neutral-700 font-medium"><?= htmlspecialchars($localisation['localisation']) ?></span>
                        </div>
                        <span class="badge" style="background-color: rgba(16, 185, 129, 0.1); color: var(--accent-soft);">
            ...
            <div class="stats-card p-6 fade-in" style="animation-delay: 1s;">
                <h3 class="section-title">
                    <i class="fas fa-star" style="background: linear-gradient(135deg, #fbbf24, var(--warning-soft)); color: white;"></i>
                    Utilisateurs Actifs
                </h3>
                <div class="space-y-3">
                    ...
                    <div class="list-item">
                        <div class="flex items-center">
                            ...
                            <span class="text-neutral-700 font-medium"><?= htmlspecialchars($user['prenom'] . ' ' . $user['nom']) ?></span>
                        </div>
