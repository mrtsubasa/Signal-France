...
<head>
    ...
    <title>Contact - E Conscience</title>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="contact-card glass-effect rounded-2xl p-8 group">
                            ...
                            <div class="space-y-3">
                                <div
                                    class="flex items-center text-gray-700 group-hover:text-blue-600 transition-colors">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between items-center mt-3">
                                        ...
                                        <div class="w-32 bg-gray-200 rounded-full h-2">
                                            <div class="progress-bar h-2 rounded-full" id="progressBar"
                                                style="width: 0%"></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="glass-effect rounded-2xl p-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div
                                ...
                                <div
                                    class="w-16 h-16 bg-blue-500 rounded-xl flex items-center justify-center mb-6 mx-auto">
