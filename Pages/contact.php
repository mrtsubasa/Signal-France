...
$nom_prefill = ($user['username'] ?? '') . ' ' . ($user['email'] ?? ''); // Just as example, but let's be more precise
$nom_val = $_POST['nom'] ?? ($user['username'] ?? '');
$email_val = $_POST['email'] ?? ($user['email'] ?? '');
...
<div class="hero-gradient min-h-screen relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl floating-icon">
        </div>
        <div class="absolute top-3/4 right-1/4 w-48 h-48 bg-white opacity-10 rounded-full blur-3xl floating-icon"
            style="animation-delay: -1s;"></div>
        <div class="absolute top-1/2 left-3/4 w-32 h-32 bg-white opacity-10 rounded-full blur-3xl floating-icon"
        ...
        <div class="text-center mb-16">
            <div class="glass-effect rounded-2xl p-10 mx-auto max-w-4xl">
                <div class="inline-block mb-6">
                    <div
                        class="w-20 h-20 bg-gray-800 bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4 floating-icon">
                ...
                <div class="mt-8">
                    <div
                        class="inline-flex items-center bg-gray-800 bg-opacity-10 rounded-full px-6 py-3 text-gray-800">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="contact-card glass-effect rounded-2xl p-8 group">
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">Notre équipe d'experts est disponible pour
                            résoudre tous vos problèmes techniques.</p>
                        <div class="space-y-3">
                    ...
                    <div
                        class="contact-card bg-gradient-to-br from-red-500 via-red-600 to-red-700 rounded-2xl p-8 text-white group relative overflow-hidden">
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-all duration-1000">
                        </div>
                        <div class="relative z-10">
                            <div class="flex items-center mb-6">
                                <div
                                    class="w-16 h-16 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center mr-4">
                                    <i class="fas fa-exclamation-triangle text-white text-2xl pulse-animation"></i>
                                </div>
                                <h3 class="text-2xl font-bold">Urgence</h3>
                            </div>
                            <p class="mb-6 opacity-95 leading-relaxed">Pour les situations critiques nécessitant une
                                intervention immédiate des services d'urgence.</p>
                            <div class="space-y-3">
                    ...
                    <div
                        class="contact-card bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-600 rounded-2xl p-8 text-white group">
                        <div class="flex items-center mb-6">
                            <div
                                class="w-16 h-16 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center mr-4 group-hover:rotate-12 transition-transform duration-300">
                                <i class="fas fa-user-secret text-white text-2xl"></i>
                            </div>
                            <h3 class="text-2xl font-bold">Contact Anonyme</h3>
                        </div>
                        <p class="mb-6 opacity-95 leading-relaxed">Votre confidentialité est notre priorité.
                            Contactez-nous en toute sécurité.</p>
                        <div class="space-y-3">
                            <div class="flex items-center">
                    ...
                    <div class="contact-card glass-effect rounded-2xl p-8">
                        ...
                        <div class="flex space-x-4">
                            <a href="#"
                                class="social-icon w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center text-white hover:shadow-lg">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="#"
                                class="social-icon w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl flex items-center justify-center text-white hover:shadow-lg">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a href="#"
                                class="social-icon w-12 h-12 bg-gradient-to-br from-blue-800 to-blue-900 rounded-xl flex items-center justify-center text-white hover:shadow-lg">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="#"
                                class="social-icon w-12 h-12 bg-gradient-to-br from-red-600 to-red-700 rounded-xl flex items-center justify-center text-white hover:shadow-lg">
                ...
                <div class="lg:col-span-2">
                    <div class="glass-effect rounded-2xl p-10">
                        <div class="mb-10">
                            ...
                            <p class="text-gray-600 text-lg leading-relaxed">Remplissez le formulaire ci-dessous et
                                nous vous répondrons dans les plus brefs délais. Votre message est important pour
                                nous.</p>
                        </div>
                        ...
                        <?php if ($message_sent): ?>
                            <div
                                class="notification bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 mb-8">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-green-700">Nous avons bien reçu votre message et vous répondrons
                        ...
                        <?php if ($error_message): ?>
                            <div
                                class="notification bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl p-6 mb-8">
                                <div class="flex items-center">
                        ...
                        <form method="POST" class="space-y-8" id="contactForm">
                            ...
                            <div
                                class="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-xl p-6">
                                <div class="flex items-center">
                                    <div class="relative">
                                        <input type="checkbox" name="anonyme" id="anonyme" class="sr-only" <?php echo (isset($_POST['anonyme']) && $_POST['anonyme']) ? 'checked' : ''; ?>>
                                        <div
                                            class="toggle-bg w-12 h-6 bg-gray-300 rounded-full shadow-inner transition-colors duration-300 cursor-pointer">
                                        </div>
                                        <div
                                            class="toggle-dot absolute w-5 h-5 bg-white rounded-full shadow top-0.5 left-0.5 transition-transform duration-300">
                                        </div>
                                    </div>
                                    <label for="anonyme"
                                        class="ml-4 text-purple-800 font-semibold cursor-pointer flex items-center">
                                        <i class="fas fa-user-secret mr-2"></i>
                                        Envoyer ce message de manière anonyme
                                    </label>
                                </div>
                                <div
                                    class="anonyme-notice mt-4 text-sm text-purple-700 bg-white bg-opacity-50 rounded-lg p-3">
                                    <i class="fas fa-info-circle mr-2"></i>
                                    En mode anonyme, votre identité sera protégée et vos données personnelles ne
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="type_demande" id="type_demande" required
                                    ...
                                    <option value="support_technique" <?php echo (isset($_POST['type_demande']) && $_POST['type_demande'] === 'support_technique') ? 'selected' : ''; ?>>🔧
                                        Support technique</option>
                                    <option value="question_generale" <?php echo (isset($_POST['type_demande']) && $_POST['type_demande'] === 'question_generale') ? 'selected' : ''; ?>>❓
                                        Question générale</option>
                                    <option value="suggestion" <?php echo (isset($_POST['type_demande']) && $_POST['type_demande'] === 'suggestion') ? 'selected' : ''; ?>>💡 Suggestion
                                        d'amélioration</option>
                                    <option value="signalement_probleme" <?php echo (isset($_POST['type_demande']) && $_POST['type_demande'] === 'signalement_probleme') ? 'selected' : ''; ?>>⚠️
                                        Signaler un problème</option>
                                    <option value="partenariat" <?php echo (isset($_POST['type_demande']) && $_POST['type_demande'] === 'partenariat') ? 'selected' : ''; ?>>🤝 Partenariat
                                    </option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-gray-500 mt-2 nom-notice">Ce nom sera masqué si vous
                                        choisissez l'option anonyme</p>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-gray-500 mt-2 email-notice">Nécessaire uniquement si vous
                                        souhaitez une réponse</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute bottom-4 right-4">
                                        <div
                                            class="typing-indicator bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-xs font-medium">
                                ...
                                <div class="flex justify-between items-center mt-3">
                                    <p class="text-sm text-gray-500 character-counter" id="charCounter">Minimum 10
                                        caractères</p>
                                    <div class="w-32 bg-gray-200 rounded-full h-2">
                                        <div class="progress-bar h-2 rounded-full" id="progressBar" style="width: 0%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-6">
                                ...
                                <button type="submit"
                                    class="btn-primary text-white px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 focus:ring-4 focus:ring-blue-300">
            ...
            <div class="mt-20">
                <div class="glass-effect rounded-2xl p-10">
                    <div class="text-center mb-12">
                        ...
                        <p class="text-xl text-gray-600 leading-relaxed">Trouvez rapidement des réponses aux
                            questions les plus courantes</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div
                            class="faq-card bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-8 border border-blue-200">
                            ...
                            <p class="text-blue-700 mb-6 leading-relaxed text-center">Cliquez sur "Créer un
                                signalement" et remplissez le formulaire avec tous les détails nécessaires.</p>
                            <div class="text-center">
                                <a href="guides.php"
                                    class="inline-flex items-center text-blue-600 font-bold hover:text-blue-800 transition-colors">
                        ...
                        <div
                            class="faq-card bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 border border-green-200">
                            <div
                                class="w-16 h-16 bg-green-500 rounded-xl flex items-center justify-center mb-6 mx-auto">
                                <i class="fas fa-clock text-white text-2xl"></i>
                            </div>
                            <h3 class="font-bold text-green-800 mb-4 text-xl text-center">
                                Délai de traitement ?
                            </h3>
                            <p class="text-green-700 mb-6 leading-relaxed text-center">Les signalements sont
                                généralement traités sous 24-48h selon leur priorité et leur complexité.</p>
                            <div class="text-center">
                                <a href="faq.php"
                        ...
                        <div
                            class="faq-card bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 border border-purple-200">
                            <div
                                class="w-16 h-16 bg-purple-500 rounded-xl flex items-center justify-center mb-6 mx-auto">
                                <i class="fas fa-eye-slash text-white text-2xl"></i>
                            </div>
                            <h3 class="font-bold text-purple-800 mb-4 text-xl text-center">
                                Contact anonyme ?
                            </h3>
                            <p class="text-purple-700 mb-6 leading-relaxed text-center">Oui, vous pouvez nous
                                contacter de manière totalement anonyme en cochant l'option correspondante.</p>
                            <div class="text-center">
                                <a href="faq.php"
                    ...
                    <div class="text-center mt-12">
                        <a href="faq.php"
                            class="inline-flex items-center bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 px-8 py-4 rounded-xl font-bold text-lg hover:from-gray-200 hover:to-gray-300 transition-all duration-300 transform hover:scale-105">
...
include_once '../Inc/Components/footers.php';
include '../Inc/Traitement/create_log.php';
?>