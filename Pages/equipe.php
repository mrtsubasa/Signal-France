...
<head>
    ...
    <style>
        * {
        ...
        @keyframes glow {
            from { box-shadow: 0 0 20px rgba(0, 0, 145, 0.3); }
            to { box-shadow: 0 0 30px rgba(0, 0, 145, 0.6); }
        }
        ...
        <div class="container mx-auto px-6 text-center relative z-10">
            <div class="fade-in-up">
                <h1 class="text-6xl md:text-7xl font-black mb-6 tracking-tight">
                    Notre <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">Équipe</span>
                </h1>
            ...
            <div class="mb-24 fade-in-up">
                ...
                <div class="flex justify-center">
                    <div class="glass-card rounded-3xl p-10 max-w-lg text-center">
                        <div class="team-avatar w-40 h-40 rounded-full mx-auto mb-8 flex items-center justify-center relative">
                        ...
                        <div class="mt-6 flex justify-center space-x-4">
                            ...
                            <div class="w-3 h-3 bg-marianne-red rounded-full animate-pulse" style="animation-delay: 0.2s;"></div>
                            <div class="w-3 h-3 bg-secondary-blue rounded-full animate-pulse" style="animation-delay: 0.4s;"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-12">
                <div class="value-card text-center fade-in-up" style="animation-delay: 0.1s;">
                    <div class="value-icon w-24 h-24 bg-gradient-to-br from-marianne-blue to-secondary-blue rounded-2xl mx-auto mb-8 flex items-center justify-center">
                        <i class="fas fa-shield-alt text-3xl text-white"></i>
                    </div>
                ...
                <div class="value-card text-center fade-in-up" style="animation-delay: 0.2s;">
                    <div class="value-icon w-24 h-24 bg-gradient-to-br from-marianne-red to-red-500 rounded-2xl mx-auto mb-8 flex items-center justify-center">
        ...
        <div class="container mx-auto px-6 text-center relative z-10">
            <div class="fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <button class="btn-modern text-white px-10 py-5 rounded-full font-semibold text-lg inline-flex items-center justify-center">
                        <i class="fas fa-envelope mr-3"></i>
                        Nous Contacter
                    </button>
                    <button class="btn-accent text-white px-10 py-5 rounded-full font-semibold text-lg inline-flex items-center justify-center">
