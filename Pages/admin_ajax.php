...
try {
    ...
    switch ($action) {
        ...
        case 'update_user_role':
            ...
            if ($userId == $user_id && $newRole !== $role) {
                throw new Exception('Vous ne pouvez pas modifier votre propre rôle');
            }

//            empecher l utilisateur de devenir admin
            if ($userId == $user_id && $newRole === 'admin') {
                throw new Exception('Vous ne pouvez pas vous auto-promouvoir en admin');
            }

//            empecher l utilisateur de devenir modérateur
            if ($userId == $user_id && $newRole === 'moderator') {
                throw new Exception('Vous ne pouvez pas vous auto-promouvoir en modérateur');
            }
