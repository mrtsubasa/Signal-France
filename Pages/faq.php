...
?>
    ...
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-france-blue to-blue-600 rounded-full mb-6">
                <i class="fas fa-question-circle text-3xl text-white"></i>
            </div>
            <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-france-blue to-blue-600 bg-clip-text text-transparent mb-4">
                Foire Aux Questions
            </h1>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Trouvez rapidement les réponses à vos questions concernant l'utilisation de la plateforme Signale France.
            </p>
        </div>
        ...
        <div class="glass-effect rounded-2xl p-6 mb-8 shadow-lg">
            <div class="relative">
                ...
                <button id="clearSearch" class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-red-500 transition-colors hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <button onclick="filterFAQ('all')" class="category-btn bg-gradient-to-r from-france-blue to-blue-600 text-white px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                <i class="fas fa-list mr-2"></i>Toutes les questions
            </button>
            <button onclick="filterFAQ('signalement')" class="category-btn glass-effect text-gray-700 px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                <i class="fas fa-exclamation-triangle mr-2 text-orange-500"></i>Signalements
            </button>
            <button onclick="filterFAQ('compte')" class="category-btn glass-effect text-gray-700 px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                <i class="fas fa-user mr-2 text-green-500"></i>Compte
            </button>
            <button onclick="filterFAQ('general')" class="category-btn glass-effect text-gray-700 px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
        ...
        <div class="space-y-6" id="faqContainer">
            ...
            <div class="faq-item glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300" data-category="signalement">
                    ...
                    <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6">
                        ...
                        <ol class="space-y-3">
                            <li class="flex items-start">
                                <span class="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">1</span>
                                <span>Cliquez sur "Créer un signalement" dans le menu principal</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">2</span>
                                <span>Remplissez le titre et sélectionnez le type d'incident</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">3</span>
                                <span>Choisissez la priorité et la localisation</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">4</span>
            ...
            <!-- Compte Questions -->
            <div class="faq-item glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300" data-category="compte">
                <div class="faq-header p-6 cursor-pointer flex justify-between items-center" onclick="toggleFAQ(this)">
                    <div class="flex items-center">
                ...
                <div class="faq-content px-6">
                    <div class="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-6">
                        <ol class="space-y-3 mb-4">
                            <li class="flex items-start">
                                <span class="bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">1</span>
                                <span>Allez dans "Mon Profil"</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">2</span>
                                <span>Cliquez sur "Modifier le profil"</span>
                            </li>
                            <li class="flex items-start">
                                <span class="bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">3</span>
            ...
            <!-- General Questions -->
            <div class="faq-item glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300" data-category="general">
                <div class="faq-header p-6 cursor-pointer flex justify-between items-center" onclick="toggleFAQ(this)">
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gradient-to-r from-indigo-400 to-purple-500 rounded-full flex items-center justify-center mr-4">
        ...
        <div class="mt-16 glass-effect rounded-2xl p-8 text-center shadow-xl">
            <div class="w-20 h-20 bg-gradient-to-r from-france-blue to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
