...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <div class="space-y-6" id="faqContainer">
        ...
        <div class="faq-item glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            <button class="faq-header w-full p-6 cursor-pointer flex justify-between items-center text-left"
    ...
    <div class="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="text-center p-6 bg-white rounded-xl shadow-sm">
                ...
                <p class="text-xs text-gray-500 mt-2">GIF supporté pour les avatars animés</p> <span
                    class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full">24-48h</span>
            </div>
            <div class="text-center p-6 bg-white rounded-xl shadow-sm">
