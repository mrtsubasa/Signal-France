...
<!-- Fond avec gradient aux couleurs Signale France -->
<div class="min-h-screen relative overflow-hidden">
    <!-- Gradient de fond officiel Signale France -->
    ...
    <div class="relative z-10 flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <!-- Logo et titre Signale France -->
            <div class="text-center transform transition-all duration-1000 ease-out">
                <div class="mx-auto h-20 w-20 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center mb-6 shadow-2xl transform hover:scale-110 transition-all duration-300 hover:rotate-3">
                    <svg class="h-10 w-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                    </svg>
                </div>
                <h2 class="text-4xl font-bold text-white mb-3 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                    Signale France
                </h2>
            ...
            <div class="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 overflow-hidden transform transition-all duration-700 ease-out hover:scale-105">
                    ...
                    <form class="space-y-6" method="POST" action="../Inc/Traitement/traitement_co.php">
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-600/20 to-blue-700/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="text-blue-300 hover:text-blue-100 transition-colors duration-200 hover:underline">
                                    Mot de passe oublié ?
                                </a>
                            </div>
                        </div>
                ...
                <div class="px-8 py-6 bg-gradient-to-r from-blue-600/10 to-blue-700/5 border-t border-white/20">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-white/80">
                        <div class="flex items-center justify-center space-x-2 p-2 rounded-lg bg-white/10 backdrop-blur-sm">
            ...
            <!-- Message d'information aux couleurs Signale France -->
            <div class="text-center transform transition-all duration-1000 ease-out">
                <div class="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-6 shadow-xl">
                    ...
                    <p class="text-white/80 text-sm leading-relaxed">
                        Signale France - Service public de signalement d'incidents.
                        <br>
...
<!-- Styles CSS personnalisés aux couleurs Signale France -->
<style>
...
.space-y-8 > *:nth-child(2) { animation-delay: 0.3s; }
.space-y-8 > *:nth-child(3) { animation-delay: 0.5s; }
