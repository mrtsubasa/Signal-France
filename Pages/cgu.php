        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 animate-fade-in">
                <div class="glass-card rounded-3xl p-12 mb-8">
                    <div class="mb-6">
                        <span
                            class="inline-block bg-white bg-opacity-20 text-white px-6 py-3 rounded-full text-sm font-medium backdrop-blur-sm">
                            🇫🇷 E Conscience
                        </span>
                    </div>
                ...
                <div class="section-card tricolor-border rounded-2xl p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="#article1"
                            ...
                            <i
                                class="fas fa-chevron-right mr-3 text-france-blue group-hover:translate-x-1 transition-transform"></i>
                            <span class="text-gray-700 group-hover:text-france-blue">1. Objet et champ
                                d'application</span>
                        </a>
                        <a href="#article2"
                            class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition-colors group">
                        ...
                        <a href="#article4"
                            ...
                            <i
                                class="fas fa-chevron-right mr-3 text-france-blue group-hover:translate-x-1 transition-transform"></i>
                            <span class="text-gray-700 group-hover:text-france-blue">4. Obligations de
                                l'utilisateur</span>
                        </a>
                        <a href="#article5"
                            class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition-colors group">
            ...
            <div id="article1" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">1</span>
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <p class="mb-6">
                            ...
                            public numérique
                            <strong class="text-france-blue">E Conscience</strong>, plateforme nationale d'alerte et
                            d'information pour la sécurité des citoyens.
                        </p>
                        <p class="mb-6">
            ...
            <div id="article2" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">2</span>
                        Définitions
                    </h2>
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-gray-50 p-6 rounded-xl">
                                ...
                                <p>La plateforme E Conscience accessible via le site web et les applications mobiles.
                                </p>
                            </div>
                            <div class="bg-gray-50 p-6 rounded-xl">
                                <h4 class="font-bold text-france-blue mb-3">Utilisateur</h4>
                                <p>Toute personne physique ou morale utilisant le service, qu'elle soit authentifiée ou
                                    non.</p>
                            </div>
                            <div class="bg-gray-50 p-6 rounded-xl">
                            ...
                            <div class="bg-gray-50 p-6 rounded-xl">
                                ...
                                <p>Information transmise par un utilisateur concernant un incident ou une situation
                                    d'urgence.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="article3" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">3</span>
                        Accès au service
                    </h2>
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <h4 class="text-xl font-semibold text-france-blue mb-4">3.1 Conditions d'accès</h4>
                        <p class="mb-6">
                            Le service est accessible gratuitement à tous les citoyens français et aux personnes
            ...
            <div id="article4" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">4</span>
                        Obligations de l'utilisateur
                    </h2>
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <h4 class="text-xl font-semibold text-france-blue mb-4">4.1 Usage conforme</h4>
                        <p class="mb-6">
                            L'utilisateur s'engage à utiliser le service de manière conforme à sa destination et aux
                            présentes CGU.
                        ...
                        <p class="mb-6">
                            ...
                            Il garantit que ce contenu ne porte pas atteinte aux droits de tiers et respecte la
            ...
            <div id="article5" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">5</span>
                        Protection des données personnelles
                    </h2>
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        <h4 class="text-xl font-semibold text-france-blue mb-4">5.1 Conformité RGPD</h4>
                        <p class="mb-6">
                            Le traitement des données personnelles s'effectue dans le respect du Règlement Général sur
            ...
            <div id="article6" class="mb-12 animate-fade-in-delay">
                <div class="section-card tricolor-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold text-france-blue mb-6 flex items-center">
                        <span
                            class="bg-france-red text-white w-10 h-10 rounded-full flex items-center justify-center mr-4 text-lg">6</span>
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                        ...
                        <p class="mb-6">
                            ...
                            des interruptions peuvent survenir pour des raisons de maintenance, de mise à jour ou de
                            force majeure.
                        </p>
                        ...
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                            ...
                            <p class="text-gray-700">
                                En cas d'urgence vitale, contactez immédiatement les services d'urgence (15, 17, 18,
                                112)
            ...
            <div class="text-center animate-fade-in-delay">
                <div class="glass-card rounded-3xl p-12">
                    ...
                    <p class="text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                        En utilisant le service E Conscience, vous reconnaissez avoir lu, compris et accepté
