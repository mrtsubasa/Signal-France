       ...
       <div class="w-80 sidebar flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-3 space-y-1 scrollbar-thin">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center p-2 rounded-lg cursor-pointer transition-all duration-200 user-item" data-user-id="<?= $userItem['id'] ?>" data-username="<?= htmlspecialchars($userItem['username']) ?>">
                        <div class="relative">
                            <img src="../Assets/Images/avatars/<?= htmlspecialchars($userItem['avatar']) ?>" 
                                 alt="Avatar" 
                                 class="w-10 h-10 rounded-full object-cover">
                            <div class="absolute -bottom-1 -right-1 w-3 h-3 bg-green-400 rounded-full border-2 border-gray-800 online-dot"></div>
                        </div>
                        <div class="ml-3 flex-1">
                            <p class="font-medium text-gray-200 text-sm"><?= htmlspecialchars($userItem['username']) ?></p>
                            <p class="text-xs text-gray-400 capitalize flex items-center">
                                <i class="fas fa-circle text-xs mr-1 <?= $userItem['role'] === 'admin' ? 'text-red-400' : ($userItem['role'] === 'moderator' ? 'text-yellow-400' : 'text-blue-400') ?>"></i>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center p-2 rounded-lg cursor-pointer transition-all duration-200 user-item opacity-60" data-user-id="<?= $userItem['id'] ?>" data-username="<?= htmlspecialchars($userItem['username']) ?>">
                        <div class="relative">
                            <img src="../Assets/Images/avatars/<?= htmlspecialchars($userItem['avatar']) ?>" 
                                 alt="Avatar" 
                        ...
                        <div class="ml-3 flex-1">
                            <p class="font-medium text-gray-400 text-sm"><?= htmlspecialchars($userItem['username']) ?></p>
            ...
            <div class="p-4 border-b border-gray-700 flex items-center justify-between">
                <div class="flex items-center">
                    <div class="relative">
                        ...
                        <div class="absolute -bottom-1 -right-1 w-2 h-2 bg-green-400 rounded-full border border-gray-800"></div>
                    </div>
                    <div class="ml-3">
                        ...
                        <p class="text-xs text-gray-400"><?= htmlspecialchars($username) ?> • <?= count($onlineUsers) + 1 ?> en ligne • <?= count($allUsersList) + 1 ?> membres</p>
                    </div>
                </div>
                
                <div class="flex items-center space-x-2">
                    <button onclick="searchMessages()" class="p-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-all duration-200" title="Rechercher">
                        <i class="fas fa-search"></i>
                    </button>
                    <button onclick="openSettings()" class="p-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-all duration-200" title="Paramètres">
                    ...
                    <div class="flex items-end space-x-3">
                        <div class="flex-1 relative">
                            ...
                            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-2">
                                <button type="button" id="emoji-btn" class="text-gray-400 hover:text-yellow-400 transition-colors duration-200" title="Emojis">
                                    <i class="fas fa-smile text-lg"></i>
                                </button>
                                <button type="button" id="file-btn" class="text-gray-400 hover:text-blue-400 transition-colors duration-200" title="Joindre un fichier">
