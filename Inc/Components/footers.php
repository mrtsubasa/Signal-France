    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="footer-section">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo $basePath; ?>Pages/search.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
                        <i class="fas fa-search text-blue-300 mr-3 w-4"></i>
                        Recherche avancée
                    </a></li>
                    <li><a href="<?php echo $basePath; ?>Pages/signal.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
            ...
            <div class="footer-section">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo $basePath; ?>Pages/guides.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
                        <i class="fas fa-book text-green-300 mr-3 w-4"></i>
                        Guide d'utilisation
                    </a></li>
                    <li><a href="<?php echo $basePath;?>Pages/faq.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
                        <i class="fas fa-question-circle text-blue-300 mr-3 w-4"></i>
                        Questions fréquentes
                    </a></li>
                    <li><a href="<?php echo $basePath; ?>Pages/contact.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
            ...
            <div class="footer-section">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo $basePath;?>Pages/cgu.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
                        <i class="fas fa-flag text-blue-300 mr-3 w-4"></i>
                        C.G.U
                    </a></li>
                    <li><a href="<?php echo $basePath;?>Pages/equipe.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
                    ...
                    <li><a href="<?php echo $basePath;?>Pages/stats.php" class="footer-link text-gray-300 hover:text-white text-sm flex items-center">
        ...
        <div class="border-t border-white/20 pt-10 mb-10">
            <div class="flex flex-col lg:flex-row items-center justify-between">
                <div class="flex items-center mb-8 lg:mb-0">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-white mb-1">Signale France</h4>
        ...
        <div class="legal-section rounded-lg p-6">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm">
                ...
                <div class="text-center md:text-right">
                    <p class="text-gray-300">&copy; 2025 SignaleFrance.fr - Service public</p>
