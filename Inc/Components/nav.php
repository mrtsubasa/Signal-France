                    ...
                    <div class="relative" id="user-dropdown">
                        <button onclick="toggleUserDropdown()"
                            ...
                            <img src="<?php echo ($latestAvatar && file_exists($avatarFile)) ? $basePath . 'Assets/Images/avatars/' . $latestAvatar : $basePath . 'Assets/Images/SignaleFrance.png'; ?>"
                                alt="Avatar" class="h-8 w-8 rounded-full object-cover border-2 border-gray-200">
                            <span
                                class="hidden md:block text-sm font-medium text-gray-700"><?php echo htmlspecialchars($username); ?></span>
